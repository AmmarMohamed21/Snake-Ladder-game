...
public:
	...
	bool SnakeLadderOverlapping(GameObject* newObj) const;

	bool FirstCellObject(GameObject* newObj) const;

	bool LastCellObject(GameObject* newObj) const;
	...
	Card* CellHasCard(CellPosition& pos);
	bool CellHasObject(CellPosition& pos);
	// ========= Other Getters =========
	...
	Player* GetCardOwner(int cardnum) const;
